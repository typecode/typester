...
var conf = {
    commands: {
        ...
        formatBlock: {
            tags: ['H1', 'H2', 'H3', 'H4', 'H5', 'H6', 'P', 'BLOCKQUOTE'],
            unwrapIfIn: ['bold', 'formatBlock', 'insertOrderedList', 'insertUnorderedList']
        },
        insertOrderedList: {
            tags: ['OL', 'LI'],
            unwrapIfIn: ['formatBlock'],
            togglable: true
        },
        insertUnorderedList: {
            tags: ['UL', 'LI'],
        ...
        getClosestBlock: function getClosestBlock() {
            ...
            while (!closestBlockEl && !this.isContentEditable(currentNode) && currentNode) {
                if (currentNode.nodeType === Node.ELEMENT_NODE) {
                    ...
                    if (formatters.base.blockElementNames.indexOf(nodeTagName) > -1) {
